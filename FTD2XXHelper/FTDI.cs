...
namespace FTD2XXHelper
{
    public class FTDI
    {
        ...
        private void FindFunctionPointers()
        {
            ...
            pFT_CreateDeviceInfoList = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_CreateDeviceInfoList");
            pFT_GetDeviceInfoDetail = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_GetDeviceInfoDetail");
            pFT_Open = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_Open");
            pFT_OpenEx = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_OpenEx");
            pFT_Close = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_Close");
            pFT_Read = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_Read");
            pFT_Write = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_Write");
            pFT_GetQueueStatus = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_GetQueueStatus");
            pFT_GetModemStatus = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_GetModemStatus");
            pFT_GetStatus = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_GetStatus");
            pFT_SetBaudRate = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_SetBaudRate");
            pFT_SetDataCharacteristics = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_SetDataCharacteristics");
            pFT_SetFlowControl = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_SetFlowControl");
            pFT_SetDtr = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_SetDtr");
            pFT_ClrDtr = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_ClrDtr");
            pFT_SetRts = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_SetRts");
            pFT_ClrRts = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_ClrRts");
            pFT_ResetDevice = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_ResetDevice");
            pFT_ResetPort = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_ResetPort");
            pFT_CyclePort = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_CyclePort");
            pFT_Rescan = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_Rescan");
            pFT_Reload = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_Reload");
            pFT_Purge = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_Purge");
            pFT_SetTimeouts = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_SetTimeouts");
            pFT_SetBreakOn = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_SetBreakOn");
            pFT_SetBreakOff = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_SetBreakOff");
            pFT_GetDeviceInfo = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_GetDeviceInfo");
            pFT_SetResetPipeRetryCount = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_SetResetPipeRetryCount");
            pFT_StopInTask = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_StopInTask");
            pFT_RestartInTask = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_RestartInTask");
            pFT_GetDriverVersion = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_GetDriverVersion");
            pFT_GetLibraryVersion = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_GetLibraryVersion");
            pFT_SetDeadmanTimeout = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_SetDeadmanTimeout");
            pFT_SetChars = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_SetChars");
            pFT_SetEventNotification = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_SetEventNotification");
            pFT_GetComPortNumber = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_GetComPortNumber");
            pFT_SetLatencyTimer = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_SetLatencyTimer");
            pFT_GetLatencyTimer = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_GetLatencyTimer");
            pFT_SetBitMode = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_SetBitMode");
            pFT_GetBitMode = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_GetBitMode");
            pFT_SetUSBParameters = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_SetUSBParameters");
            pFT_ReadEE = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_ReadEE");
            pFT_WriteEE = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_WriteEE");
            pFT_EraseEE = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_EraseEE");
            pFT_EE_UASize = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_EE_UASize");
            pFT_EE_UARead = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_EE_UARead");
            pFT_EE_UAWrite = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_EE_UAWrite");
            pFT_EE_Read = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_EE_Read");
            pFT_EE_Program = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_EE_Program");
            pFT_EEPROM_Read = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_EEPROM_Read");
            pFT_EEPROM_Program = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_EEPROM_Program");
            pFT_VendorCmdGet = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_VendorCmdGet");
            pFT_VendorCmdSet = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_VendorCmdSet");
            pFT_VendorCmdSetX = libraryLoader.GetProcAddress(hFTD2XXDLL, "FT_VendorCmdSetX");
        }
